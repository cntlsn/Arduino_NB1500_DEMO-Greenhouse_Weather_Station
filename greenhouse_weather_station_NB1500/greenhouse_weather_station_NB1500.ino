/*
  ...
  and Light value from a LDR, sends them to a webpage
  through an HTTP request to ThingSpeak.
      
  CIRCUIT:
  Connect the DHT to digital pin 2.
  Connect the LDR to analog pin A2.
  Connect a RGB LED to digital pins Red>8, Green>7, Blue>6 

  NOTES:
  ThingSpeak channel https://thingspeak.com/channels/477356/
  Web page https://cntlsn.github.io/Arduino_NB1500_DEMO-Greenhouse_Weather_Station/
*/
